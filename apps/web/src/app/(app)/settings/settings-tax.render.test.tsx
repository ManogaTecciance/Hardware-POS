...
const settingsRecord = (taxRatePercent: number): AppSettings => ({
  currency: 'LKR',
  // main — `timezone` is a required sibling of `documents` on AppSettings
  // (UTC storage, per-business zone); the page reads it into the Timezone
  // select that sits on this same tab, above the rate.
