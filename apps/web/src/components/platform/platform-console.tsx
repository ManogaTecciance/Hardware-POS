...
/**
 * D55 — the platform console: the workspace list and the console's only
 * creation surface, wrapped in its own chrome.
 *
 ...
 *
 * Served at /dashboard (PO request, 2026-08-17): one post-login URL for
 * everyone. `PlatformConsoleBoundary` in the (app) layout renders THIS screen
 * there for platform admins instead of the workspace shell, so this component
 * assumes an authenticated platform admin and carries no redirect logic of
 * its own.
 */
