...
/**
 * Retail POS checkout (Tile Shop / Hardware / Retail profiles).
 *
 * Extracted verbatim from `app/(app)/pos/page.tsx` so `/pos` can dispatch
 * on business type — the Restaurant profile now routes to a different
 * workspace (`PosTakeawayWorkspace` and friends). Behaviour and layout
 * are unchanged from before the extraction.
 */
export function PosRetailCheckout() {
