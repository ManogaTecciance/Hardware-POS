...
export function OrdersPage({ session, branchId }: Props) {
  ...
  /*
   * D152c — a supervisor asks for the whole queue explicitly rather than
   * letting the server's "mine" default (D152b) apply: "my orders" is a
  ...
  /** D152c — the chips are the floor's control; the office does not get them. */
      ...
      <Card>
        <CardContent className="space-y-3 p-4">
          ...
          {/* D152 — whose orders. First, because it frames every count below it:
              ...
              every number on the screen. D152c — NOT RENDERED for a supervisor,
