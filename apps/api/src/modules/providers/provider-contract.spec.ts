...
describe('no Prisma migration was generated by Slices 5 through 6C-A', () => {
  ...
  it('no migration creates a provider, inventory or restaurant table', () => {
    ...
    // 60 + the D99 retail enum migration (2.1). The exact-set assertion on the
    // line above is what actually guards the contents; this length is the
    // "the analyser did not silently skip a file" check D30 asks for.
