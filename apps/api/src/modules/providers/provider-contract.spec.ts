...
describe('no Prisma migration was generated by Slices 5 through 6C-A', () => {
  ...
  it('the migration set is exactly the 86 listed — the branch’s 60, main’s 8, fix/table-tab’s 2, fix/issues-restaurant’s 1, feature/retail-template’s 13, merge/restaurant-changes’ 1 and D171’s 1', () => {
  ...
  it('no migration creates a provider, inventory or restaurant table', () => {
    ...
    // list agree.
    // 86 since D171 added `20260917000000_scope_receipt_number_per_tenant`.
