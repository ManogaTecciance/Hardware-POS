...
describe('no Prisma migration was generated by Slices 5 through 6C-A', () => {
  ...
  it('the migration set is exactly the 85 listed — the branch’s 60, main’s 8, fix/table-tab’s 2, fix/issues-restaurant’s 1, feature/retail-template’s 13 and merge/restaurant-changes’ 1', () => {
    ...
    expect(migrationDirs()).toEqual([
      ...
      // merge/restaurant-changes, D143 — `KitchenTicket.stationId` becomes
  ...
  it('no migration creates a provider, inventory or restaurant table', () => {
    ...
    // merge/restaurant-changes' 1 (D143). The unnamed `20260831055102_setup1` two
