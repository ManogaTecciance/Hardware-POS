...
const ROUTE_CLASSIFICATION: Record<string, Classification> = {
  ...
  'POST /restaurant/branches/:branchId/table-sessions/:sessionId/waiter': { module: 'TABLE_MANAGEMENT', guard: 'ENFORCED', scope: B },
  ...
  // main, 2026-09-07 — ticking a credit invoice off. Route-level RETAIL_POS guard
  // added in the merge, matching every other sales write route here.
  'POST /sales/:id/marked-paid': { module: 'RETAIL_POS', guard: 'ENFORCED', scope: T },
