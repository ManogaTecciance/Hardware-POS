...
| PROD-066 | A same-product offer says how close it is, and still lets you pay (D155) | With a “buy 5 get 1” on ONE product: put 4 in the cart, then 5, then 6, then 11 | At 4 nothing; at 5 “Add 1 more … and one is free” with **Proceed to Payment still enabled**; at 6 the prompt goes and Rs 500 comes off; at 11 it prompts again for the second free one. At no quantity is payment blocked | P | Not Run |
| PROD-067 | A debt still blocks, and outranks the offer (D155/4.14) | With a “buy 2 Shirt get 1 Tie”: add 2 shirts; then add 5 ties as well so both offers are live | The shirt offer blocks payment (“Payment is unavailable…”) because a tie is genuinely owed; with both live only the blocking notice shows — one instruction at a time, and the blocking one wins | N | Not Run |
